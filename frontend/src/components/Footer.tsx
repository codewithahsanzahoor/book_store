        ...
        <footer className="footer p-10 bg-neutral text-neutral-content">
            <nav>
                ...
                <p className="max-w-xs">
                    Your one-stop shop for discovering and purchasing your next
                    favorite book. Dive into a world of stories.
                </p>
            </nav>
            <nav>
